...
echo 1 = Season Size
echo 2 = Entire Game
echo 3 = Extra Language - DIDN'T work it!
echo 4 = 4K Textures
...
echo I'm not tested this manifests: White_Noise, Para_Bellum, Grim_Sky, Burnt_Horizon and ALL 4K Textures
...
echo Updated Version: 2020 Aug 14
pause
cls
goto mainmenu
